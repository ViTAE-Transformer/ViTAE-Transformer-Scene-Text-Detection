...
def main():
    ...
    # for item in dataset:
    #     filename = os.path.join(args.output_dir, item.get('img_metas').data.get('ori_filename')) if args.output_dir is not None else None
    #
    ...
    #
    #     imshow_det_bboxes(
    #         item['img'].data.numpy().transpose(1,2,0),
    #         item['gt_bboxes'].data.numpy(),
    #         item['gt_labels'].data.numpy(),
    #         gt_masks,
